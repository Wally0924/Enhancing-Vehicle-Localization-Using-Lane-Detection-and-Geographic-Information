...
class BaseMatcher:
    ...
    def match(self, path, unique=False, tqdm=None, expand=False, vector_gps = None):
        ...
        self.vector_gps = vector_gps
        ##original##############
        # Initialisation
        if expand:
            self.expand_now += 1
            # print('self.expand_now', self.expand_now)
            if self.path != path:
